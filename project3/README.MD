...
To run this script, you will need to download it from this Github repository [Link to Script}(./project3.py). I prefer to use Powershell ISE to run the script, but any IDE compatible with .ps1 files will work.
